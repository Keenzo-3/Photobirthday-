...
const correctPW = ['dreimabait','october/04/2009','10-04-2009','october 4 2009','masterdrei'];
...
/* ---------------- Letters & Envelope ----------------*/
const letters = {
  1:{ icon:'🌙', title:'Memories Galaxy', color:'#c9a7ff', photo:'photo1.jpg',
  ...
  2:{ icon:'💗', title:'Love Galaxy', color:'#ff69b4', photo:'photo2.jpg',
  ...
  3:{ icon:'✨', title:'Dream Galaxy', color:'#ffd86b', photo:'photo3.jpg',
  ...
  4:{ icon:'🌎', title:'Future Galaxy', color:'#6cddff', photo:'photo4.jpg',
...
function openLetterScreen(g){
  ...
  function doOpen(){
    ...
    setTimeout(()=>{
      ...
      var photoEl = document.getElementById('letterPhoto');
      if(photoEl){ photoEl.parentElement.style.display=''; photoEl.src = ltr.photo; photoEl.style.display='block'; }
      typeLetter(g);
    }, 1180);
  }
